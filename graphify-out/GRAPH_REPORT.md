...
## Corpus Check
- 91 files · ~44,720 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 617 nodes · 1474 edges · 38 communities (34 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00a3a01e`
...
Cohesion: 0.10
Nodes (20): AdaptateurMemoire, BaseChargee, ChargementBase, chargerBase(), enregistrerLigne(), FichierNonReconnu, charger(), espace() (+12 more)
...
Cohesion: 0.09
Nodes (6): OptionsDepot, cheminPage(), DepotEspace, ModificationMiseEnPage, Calcul, Vue
...
Cohesion: 0.08
Nodes (37): cheminVue(), COULEURS, EtatBase, OptionsEspace, relationVers(), assurerListe(), assurerMap(), barreLaterale() (+29 more)
...
Cohesion: 0.11
Nodes (13): LigneChargee, afficher(), DepotBase, superposer(), LigneVue, colonnesDeLaVue(), Groupe, groupeOption() (+5 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (42): aleatoire(), aujourdhui(), planifier(), calculsPour(), EtatEspace, schemaDe(), TypeCreable, TYPES_CREABLES (+34 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (58): agreger(), BaseACalculer, calculer(), calculerInverse(), Calculs, erreur(), preparerRollup(), RollupPret (+50 more)

### Community 38 - "Community 38"
Cohesion: 0.10
Nodes (19): contientCle(), Entree, Planifier, ouvrir(), ouvrir(), Aleatoire, cleColonne(), dedoublonner() (+11 more)
...
## Knowledge Gaps
- **150 isolated node(s):** `Commandes`, `Architecture et conventions (refacti)`, `Tests`, `Jalons`, `graphify` (+145 more)
...
- **Why does `DepotEspace` connect `Community 9` to `Community 2`, `Community 38`, `Community 39`, `Community 15`, `Community 19`, `Community 20`, `Community 24`, `Community 26`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `DepotBase` connect `Community 20` to `Community 2`, `Community 38`, `Community 39`, `Community 9`, `Community 15`, `Community 19`, `Community 24`, `Community 26`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `colonne` connect `Community 26` to `Community 38`, `Community 39`, `Community 15`, `Community 19`, `Community 20`, `Community 24`?**
